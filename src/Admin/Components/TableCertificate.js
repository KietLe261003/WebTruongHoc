              ...
              <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-800">
                  <tr>
                    ...
                    <th scope="col" class="px-3 py-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Số chứng chỉ</th>
                    <th scope="col" class="px-4 py-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Loại</th>
                    <th scope="col" class="px-4 py-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400 flex justify-center">Hoạt động</th>
                  </tr>
                </thead>
