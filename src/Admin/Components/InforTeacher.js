...
function InforTeacher(props) {
    ...
    return (
        <div class="bg-white flex flex-row" style={{height: 500}}>
            {teacher && 
            ...
            {err && <h2 style={{color: red}}>Teacher not Found</h2>}
            <div class="lg:col-span-1 p-4 bg-white mt-3 w-full h-full" id="posted">
                        ...
                        <form class="h-full">
                            <div class="mb-4 w-full bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
                                ...
                                <div class="py-2 px-4 bg-white rounded-b-lg dark:bg-gray-800">
                                    ...
                                    <textarea id="editor" rows="15" value={description} onInput={handleInput} class="block px-0 w-full text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea>
                                </div>
                            </div>
                            <button type="button" onClick={handleUpdateDoc} class="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800">
                                Sửa
                            </button>
                        </form>
