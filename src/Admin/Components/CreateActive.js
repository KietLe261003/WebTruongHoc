...
import { Timestamp, collection, doc, getDoc, getDocs, limit, orderBy, query, setDoc, updateDoc } from "firebase/firestore";
...
function CreateActive(props) {
    ...
    const handleSubmit = async (e) => {
        ...
        const q = query(collection(db, "active"), orderBy("timeCreate", "desc"), limit(1));
