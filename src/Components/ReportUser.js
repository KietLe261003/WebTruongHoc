                    ...
                    <form onSubmit={handleSubmit}>
                        <div class="grid md:grid-cols-2 grid-cols-1 gap-6">
                            <div class="md:col-span-2">
                                <input type="text" id="fname" name="fname" placeholder="Nội dung báo cáo"
                                    class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-700 "
                                />
                            </div>  
                            <div class="md:col-span-2">
                                <label for="subject" class="float-left block  font-normal text-gray-400 text-lg">Gửi hình ảnh minh chứng nếu có:</label>
                            ...
                            <div class="md:col-span-2">
                                <textarea name="message" rows="5" cols="" placeholder="Mô tả chi tiết " class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-700"></textarea>
                            </div>
